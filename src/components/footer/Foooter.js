      ...
      <div id="footer">
        <div class="row p-4" style={{ backgroundColor: "white", height:"auto" }}>
          ...
          <div className="col-lg-4 col-md-6 col-sm-6 col-12" style={{ fontSize: "12px",marginBottom:"2rem"  }}>
            <b style={{ color: "#2b398e", fontSize: "18px" }}>Çalışma Takvimi</b>
            <hr/>
          ...
          <div className="col-lg-4 col-md-6 col-sm-6 col-12" style={{ fontSize: "15px",marginBottom:"2rem"  }}>
            <p style={{ color: "#2b398e", fontWeight: "bold", fontSize: "18px" }}>
            ...
            <p style={{  fontSize: "14px", textAlign: "left" }}>
              ...
              &nbsp;
              0542 215 09 93  <FontAwesomeIcon icon="coffee" size="lg" />
              <br />
            <br/>
              <p style={{  fontSize: "14px", textAlign: "left" }}>
              {" "}
          ...
          <div className="roof-phone">
              <a href="tel: +905422150993" className="phone_float" target="_blank" rel="noopener noreferrer">
                  <PhoneIcon className="phone-icon"/>  
              </a>
          </div>

          <div className="roof-whatsapp">
              <a href="https://wa.me/+905422150993" className="whatsapp_float" target="_blank" rel="noopener noreferrer">
